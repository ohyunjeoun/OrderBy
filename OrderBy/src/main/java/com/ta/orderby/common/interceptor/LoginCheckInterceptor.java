package com.ta.orderby.common.interceptor;
 ...
 *       - 인터셉터를 구현하기 위해서는 HandlerInterceptor 인터페이스를 구현 해야한다.
 * 
 * 필터와의 차이점
 *       - 필터는 서블릿 실행 전에 실행된다. (web.xml에 설정)
 *       - 인터셉트는 디스패처 서블릿 수행 후 컨트롤러에 요청을 넘기기 전에 실행된다. (Servlet-context.xml)
 */
